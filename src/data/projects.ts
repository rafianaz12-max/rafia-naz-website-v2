...
},
{
  ...
  gallery: [
    "/images/projects/web/flowlab.png",
     "/images/projects/web/flowlab-2.png",
      "/images/projects/web/flowlab-3.png",
       "/images/projects/web/flowlab-4.png",
        "/images/projects/web/flowlab-5.png",
  ],
  featured: true,
},
{
  kind: "web",
  slug: "the-legacy-school",
  title: "The Legacy School",
  shortDescription:
    "A modern and responsive school website designed to provide students, parents, and visitors with clear access to school information and services.",
  description:
    "The Legacy School is a modern educational website designed to present the school's identity, academic environment, programs, facilities, and important information through a clean and engaging digital experience. The platform focuses on responsive design, intuitive navigation, and a professional school-oriented interface that makes information easy to explore for students, parents, and visitors.",
  category: "Web App",
  technologies: [
    "Next.js",
    "TypeScript",
  ...
  features: [
    ...
    "Professional homepage with school-focused design",
    "Information sections for students, parents, and visitors",
    "Responsive navigation and user-friendly interface",
    "Clean educational website layout",
    "Mobile and desktop responsive design",
    "Deployed online through Vercel",
  ],
  developmentProcess: [
    "Planned the website structure and organized the main school information sections",
    "Designed a modern educational interface with a focus on clarity and visual appeal",
    "Built reusable components using Next.js, React, and TypeScript",
    "Implemented responsive layouts using Tailwind CSS for different screen sizes",
    "Optimized the website for smooth navigation and public accessibility",
    "Deployed the completed website through Vercel",
  ],
  challenges: [
    "Creating a professional school website while keeping the interface simple and easy to navigate",
    "Organizing different types of educational and institutional information into clear sections",
    "Maintaining a consistent responsive design across desktop, tablet, and mobile devices",
    "Creating an engaging visual experience without making the interface unnecessarily complex",
  ],
  solutions: [
    "Structured the website into clear and logically organized sections",
    "Used reusable React components to maintain consistency throughout the application",
    "Applied responsive Tailwind CSS layouts for different screen sizes",
    "Focused on clean typography, spacing, and visual hierarchy to improve readability",
    "Optimized the final application for reliable deployment through Vercel",
  ],
  conclusion:
    "The Legacy School demonstrates how modern web technologies can be used to create a professional digital presence for an educational institution. The project combines responsive design, structured content, and a user-friendly interface to make school information easier to explore and access.",
  githubUrl: "https://github.com/rafianaz12-max/the-legacy-school",
  liveUrl: "https://the-legacy-school.vercel.app/",
  bannerImage: "/images/projects/web/result.png",
  gallery: [
    "/images/projects/web/result.png",
     "/images/projects/web/result-2.png",
      "/images/projects/web/result-3.png",
       "/images/projects/web/result-4.png",
        "/images/projects/web/result-5.png",
  ],
  featured: true,
},
{
  kind: "web",
  slug: "build-career-ai",
  title: "Build Career AI",
  shortDescription:
    "An AI-powered career guidance platform designed to help users explore career paths, identify suitable skills, and make informed career development decisions.",
  description:
    "Build Career AI is an AI powered career guidance platform designed to help users better understand their career options and develop a structured path toward their professional goals. The platform uses an interactive interface and AI capabilities to provide personalized career guidance, explore relevant skills, and help users identify potential learning and development directions.",
  category: "AI",
  technologies: [
    "Next.js",
    "TypeScript",
  ...
  features: [
    ...
    "Career path exploration and guidance",
    "Skill identification and development suggestions",
    "Interactive AI-powered user experience",
    "Clean and responsive interface",
    "Accessible online through Vercel deployment",
  ],
  developmentProcess: [
    "Identified common challenges users face when choosing and planning career paths",
    "Designed an interactive interface for collecting relevant user information and career goals",
    "Built the application using Next.js, TypeScript, and Tailwind CSS",
    "Integrated AI capabilities to generate contextual career guidance",
    "Structured career information and recommendations into an easy-to-understand experience",
    "Optimized and deployed the application through Vercel",
  ],
  challenges: [
    "Providing useful career guidance while handling different user backgrounds and goals",
    "Designing AI interactions that produce relevant and understandable responses",
    "Organizing career and skill information into a simple user experience",
    "Maintaining a responsive interface while integrating AI functionality",
  ],
  solutions: [
    "Designed structured user inputs to provide the AI with relevant career context",
    "Used AI generated responses to create personalized career guidance",
    "Organized recommendations into clear career and skill development directions",
    "Built reusable and responsive components using Next.js and Tailwind CSS",
    "Added a simple conversational experience to make career exploration easier for users",
  ],
  conclusion:
    "Build Career AI demonstrates how artificial intelligence can be integrated into a modern web application to support career exploration and skill development. The project combines AI capabilities with a simple, responsive interface to provide users with a more interactive approach to career planning.",
  githubUrl: "https://github.com/rafianaz12-max/career-compass",
  liveUrl: "https://build-career-ai.vercel.app/",
  bannerImage: "/images/projects/web/career.png",
  gallery: [
    "/images/projects/web/career.png",
     "/images/projects/web/career-2.png",
      "/images/projects/web/career-3.png",
       "/images/projects/web/career-4.png",
  ],
  featured: true,
},
  {
